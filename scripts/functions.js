...
<input class="spoil-button" type="checkbox" tabindex="-1">
	...
	<blockquote class="spoil-Untext"><ul>
		<li>Зайдя на сервера Grand Rust, вы автоматически соглашаетесь с соблюдением всех правил проекта. Незнание правил не освобождает Вас от ответственности.</li>
		<li>Администраторы сервера имеют право изменить или дополнить правила сервера. Изменения правил логируется в discord-сервере проекта.</li>
		<li>Проверяющие и администрация сами выбирают наказание для игрока в зависимости от степени нарушения и обстоятельств. Игрок может отделаться простым предупреждением, а может и попасть в бессрочный бан.</li>
		<li>Проверяющие и Главная Модерация отвечает только за проверку на стороннее ПО у игроков. Вызов проходит с появлением уведомление у Вас на экране, вызовы через чат не производятся.</li>
		<li>Игрок несет ответсвенность за все свои аккаунты. Если вы получили бан на одном аккаунте, Вы получите его и на последующих. Если вы имеете игровую блокировку по игре Rust (EAC) на одном из аккаунтов, Вы получите бан на проекте по причине "EAC" и на последующих.</li><br>
		<li>Администрация и Главная Модерация имеем право Вас забанить без проверки, если на другом проекте, при наличии пруфов, Вы уже были замечены с читами/макросами/игровой блокировкой.</li><br>
		<li>Администрация не компенсирует игровые предметы, утраченные по вашей ошибке, серверных лагов, багов игры или контактом с нарушителями.</li>
		<li>Вам никто и ничего не должен, а также ни чем не обязан.</li>
	</ul></blockquote>
</div></div>
<br>
<div class="x-spoiler">
<input class="spoil-button" type="checkbox" tabindex="-1">
	...
	<blockquote class="spoil-Untext"><ul>
		<li>Запрещено использовать/хранить/приобретать/распространять стороннее ПО или любые другие средства, позволяющие получить преимущество над другими игроками. Использование услуг читеров/макросников приравнивается к хранению.</li>
		<li>Игрокам запрещено строить дома в текстурах, а также застраивать игровые локации, препятствующие к использованию РТ.</li>
		<li>Запрещено строиться или хранить лут в текстурах/скалах/камнях и подобных недоработках карт.</li>
		<li>Игрокам запрещено строить игровые постройки и предметы багом/недоработкой например в целях сделать несколько предметов друг в друге, слишком близко или с невозможностью уничтожения.</li>
		<li>Запрещено строить "усы" к дому дальше 10 квадратов в длину (треугольники засчитываются так же). На первый раз игрок может отделаться как предупреждением с последующим самостоятельным уничтожением, либо лишние "усы" или весь дом уничтожает администратор. При повторном нарушении усов (свыше 5 квадратов) дом может подлежать полному уничтожению, либо бану всех хозяев.</li>
		<li>При обнаружении бага или недоработки игры/сервера незамедлительно сообщите администрации об этом через сообщение в нашу группу Вк.</li>
		<p style="text-align: center;"><i class="fa fa-info-circle"></i><u> БАН – за нарушение вышеперечисленных правил на всех серверах GRAND RUST.</u></p>
	</ul></blockquote>
</div></div>
<br>
<div class="x-spoiler">
<input class="spoil-button" type="checkbox" tabindex="-1">
	...
	<blockquote class="spoil-Untext"><ul>
		<li>Запрещено превышать лимит игроков в команде, установленный сервером. (см. название сервера MAX 1/2/3/5)</li>
		<li>Перемирие и альянсы с соседями приравниваются к нарушению правил о лимите, если в сумме вас больше указанного в названии сервера.</li>
		<li>Частая смена напарника прираванивается к нарушению правил о лимите.</li>
		<li>Запрещено рейдить и антирейдить в 1+/2+/3+/5+ (подсад, доп.люди на обороне и любое кооперирование против других игроков).</li>
		<li>Запрещена смена напарника на время, если ваш основной напарник продолжит с вами играть.</li>
		<li>Разрешено сменить напарника, если ваш предыдущий напарник в дальнейшем не будет с вами контактировать каким-либо образом, либо перестал играть.</li>
		<p style="text-align: center;"><i class="fa fa-info-circle"></i><u> БАН – за нарушение вышеперечисленных правил на всех серверах GRAND RUST.</u></p>
	</ul></blockquote>
</div></div>
...
<input class="spoil-button" type="checkbox" tabindex="-1">
	...
	<blockquote class="spoil-Untext"><ul>
		<li>Запрещен флуд и спам сообщений, если это мешает другим игрокам.</li>
		<li>Запрещено продавать или делать вид, что вы продаёте читы/макросы.</li>
		<li>Запрещено употребление нецензурных выражений и оскорбления других игроков.</li>
		<li>Запрещена реклама сторонних проектов и платформ в любой форме.</li>
		<li>Запрещено выдавать себя за администратора или проверяющего проекта. Запрещено использование "ADMIN" или "MODER", или похожие слова в нике.</li>
		<li>Намеренное изменение нецензурной речи и оскорблений для обхода автоматического мута.</li>
...
<input class="spoil-button" type="checkbox" tabindex="-1">
	...
	<blockquote class="spoil-Untext"><ul>
		<li>Запрещено обращаться в репорт:</li>
		...
		<li>Запрещено хамское отношение, попытка дискредитации, клевета или обман администрации сервера, а также оскорбление проекта, а также дезинформация в личных целях.</li>
		<li>Запрещено оскорбление Администрации/Модерации/Проекта в любых формах.</li>
		<li>Игрокам запрещено какими-либо действиями создавать помеху работе администрации.</li>
		<p style="text-align: center;"><i class="fa fa-info-circle"></i><u> БАН/МУТ – за нарушение вышеперечисленных правил на всех серверах GRAND RUST.</u></p>
	</ul></blockquote>
</div></div>
<br>
...
<input class="spoil-button" type="checkbox" tabindex="-1">
	...
	<blockquote class="spoil-Untext"><ul>
		<li>На проекте есть только администрация и проверяющие (игроки ответственные за проверку на стороннее ПО).</li>
		<li>Администрации запрещается играть на сервере как простой игрок.</li>
		<li>Проверяющие могут играть на серверах как игрок, но они не следят за игрой с превышением лимита.</li>
		<li>Запрещено нарушать правила ивентов прописанных в разделе "Правила участия в ивентах" ниже, в /help на серверах либо в отдельных командах плагинов, например /tc</li>
		<li>Администрация не несет ответственности за обмены на сервере, не отвечает за то кому Вам доверять.</li>
		<li>Запрещено распространять любую личную информацию Администрации/Модерации/Проверяющих, непубличную информацию и уязвимости проекта</li>
		<li>Жалобы на превышение лимита в приоритете на рассмотрение - при наличии видеозаписи либо скринов. Если вы заметили игроков превышающих лимит в команде, или нарушающих иные правила, пожалуйста, сделайте скрин/видеозапись либо запомните ники игроков и предоставьте нам через <a href="https://vk.me/grandrust_server" target="blank">группу ВК.</a></li>
		<li>Администрация и проверяющие имеют право забанить весь состав друзей/сокланов за игру с читером, за игру с макросами при повторном аккаунте макросника к этим же друзьям а также за игру с использованием услуг читеров.</li>
		<li>Администрация и проверяющие имеют право забанить вас при наличии веских доказательств при проверке на другом проекте.</li>
		<li>Вы можете быть забанены автоматической системой обнаружения подозрительных действий игрока, если вы не совершали противоправных действий, пожалуйста, напишите нам в группу ВК если вы были забанены по ошибке.</li>
		<li>Запрещена попытка продажи либо покупки, а также продажа игровых предметов за реальные деньги.</li>
		<p style="text-align: center;"><i class="fa fa-info-circle"></i><u> БАН/МУТ – за нарушение вышеперечисленных правил на всех серверах GRAND RUST.</u></p>
	</ul></blockquote>
</div></div>
<br>
...
<input class="spoil-button" type="checkbox" tabindex="-1">
	...
	<blockquote class="spoil-Untext"><ul>
		<li>Активированный товар или привилегию невозможно вернуть, заморозить либо перенести на другой сервер. Если Вы забрали товар из корзины на сервере, вернуть его невозможно.</li>
		<li>В случае ошибочного пополнения баланса возврат средств невозможен.</li>
		<li>Если Вас заблокировали на проекте, возврат средств невозможен, как и перевод другому игроку. Вы в ответе за свой аккаунт, товары и баланс на нем.</li>
		<li>В случае возврата товара в корзине магазина стоимость товара возвращается бонусами.</li>
		<li>Денежный эквивалент в виде бонусов невозможно переводить на другие аккаунты.</li>
		<li>Любые товары, купленные на проекте, не подлежат переносу на другие аккаунты, не подлежат возврату, продаже или обмену, в том числе на денежные средства, выплата денежного эквивалента промокода не производится.</li>
	</ul></blockquote>
</div></div>
<br>
<div class="x-spoiler">
<input class="spoil-button" type="checkbox" tabindex="-1">
	...
	<blockquote class="spoil-Untext"><ul>
		...
		<p>- Игрок может получить денежный приз (или его эквивалент) за ивент только после проверки всех требований которые победитель выполнит в соответствии с настоящими правилами, а также пройдёт проверку на читы/макросы.</p>
		<p>- Запрещено что либо чистить в компьютере, переустанавливать операционную систему или менять оборудование на протяжении всего месяца, за который проходит ивент.</p>
		<li>Уникальный шкаф</li>
		<p>- Запрещено покупать, отдавать и т д. шкаф. Очки за шкаф зачтутся только в ходе честной игры.</p>
		<p>- Запрещено покупать/продавать информацию по местонахождению уникального шкафа у сторонних игроков, владельца или друзей владельца.</p>
		<p>- Игрок заабузивший нашивку, теряет возможность принять повторное участие от 60 дней, а также не получает нашивку.</p>
		<p>- Игрок, продавший или отдавший шкаф, теряет возможность принять повторное участие от 60 дней.</p>
		...
		<p>- Игрок, у которого уничтожили шкаф, теряет 50 очков. Игрок всё равно может выиграть, если наберёт баллов более 0</p>
		...
		<p>- Рейтинг победителей не смещается, в случае если игрок выбыл с таблицы рейтинга.</p>
	</ul></blockquote>
</div></div>
<br>
<div class="x-spoiler">
<input class="spoil-button" type="checkbox" tabindex="-1">
	...
	<blockquote class="spoil-Untext"><ul>
		<li>Команду проекта не интересует ваша личная информация на проверках. Проверки не записываются для личных целей. Нас не интересуют ваши личные файлы либо пароли. Проверка проходит исключительно для нахождения строннего ПО, при наличии репортов со стороны игроков.</p><br>
		<li>Проверка на стороннее ПО проводится, только если вы на сервере, не АФК и не имеете Рейд Блок.</li>
		<li>Проверки проходят только один на один с проверяющим или с несколькими проверяющими.</li>
		<li>Как только вас вызвали на проверку - вам даётся до 10 минут, чтобы связаться с проверяющим, действуя инструкциям на экране, в противном случае вы можете получить блокировку.</li>
		<li> Если вы проходите на проверку и закрываете игру, без ведома поверяющего, вы можете получить бан.</li>
		<li>Связь происходит посредством Skype/Discord с демонстрацией вашего экрана. Либо при помощи удаленного доступа, программами - AnyDesk и TeamViewer, если Ваше соединение с интернетом не может показывать хорошее качество связи.</li>
		<li>Если вы покидаете сервер после вызова, не предоставив контакты для связи и не пройдя проверку, вы получаете бан на всех серверах.</li>
		<li>Проверка осуществляется в автоматическом режиме с помощью программы RustCheatCheck, скачать которую вы можете на официальном сайте RustCheatCheck.ru. Также могут понадобится такие программы, как - Recuva, Everything, Lastactivity и т.д. Вы также имеете право отказаться скачивать их, что приравнивается к отказу проверки и последующий бан.</li>
		<li>Информация, которая может быть получена при вашей проверке не распространяется, за исключением результатов проверки, которые могут быть затребованы администрацией других проектов, также использующих сервис RustCheatCheck для своих проверок.</li>
		<li>Также мы можем затребовать результаты ваших предыдущих проверок других проектов, использующих сервис RustCheatCheck, которые приобщаются к вашему делу (при наличии веских доказательств) и могут повлиять на окончательное решение и дальнейший бан.</li>
		<li>Предварительное решение после проверки озвученное проверяющим может отличатся от окончательного, принятого администрацией.</li>
		<li>Если вы не согласны с окончательным решением, принятым не в соответствии настоящих правил, вы можете затребовать у администратрации материалы дела о вашей блокировке направив сообщение в группу по вопросам банов - <a href="https://vk.com/grmoder" target="blank">GRAND RUST | Модерация</a></li><br>
		<li>Если вы приобрели аккаунт с банами на нашем проекте, разбан либо перепроверка невозможна.</li>
		<li>Проверяющий в праве потребовать Ваши личные переписки во всех доступных мессенджерах для проверки факта приобретения сторонних ПО. Также проверяющий имеет право просматривать файлы/картинки/видео/аудио,  если это будет связано с игрой/читами/макросами/банами/покупкой акка. Если во время проверки Вы удалиете какой-либо файл, без ведома проверяющего - это приравнивается к отказу от проверки и последующий бан.</li>
		<li>Проверка может длиться до тех пор, пока проверяющий не проверит всё, что считает нужным.</li>
		<li>Рекомендуется записывать откат в ходе спорного рейда (в нычку, в шкаф либо в лут) Главный модератор в праве попросить вас показать откат самого рейда. В ваших интересах доказать, что вы играли без просветов и сторонних ПО.</li>
		<li>Запрос откатов возможен лишь в крайних случаях. </li>
	</ul></blockquote>
</div></div>
<br>
<div class="x-spoiler">
<input class="spoil-button" type="checkbox" tabindex="-1">
	...
	<blockquote class="spoil-Untext"><ul>
		<li>Мы не даем второй шанс. Если бан обоснован, имеет доказательства и основания для бана - разбан невозможен.</li>
		<li>Игрок в праве обжаловать свой бан (игра+ либо  багоюз), если у него имеется откат (видеозапись события) на момент нарушения.</li>
		<li>Игрок в праве обжаловать свой бан на просвет, если у него имеется откат (видеозапись события) на момент нарушения. (Бан без проверки аккаунта возможен в случае многократный рейдов в нычки/лутовые игроков).</li>
		<li>Игрок может избежать бан за мультиаккаунт, если при проверке нового аккаунта - он будет чистый и не будет найдено следов скрывания старого аккаунта. В данном случае игрок может играть с нового аккаунта, без последующего бана на нем, но при условии что бан был выдан более 3 лет назад на основной аккаунт.</li>
		<li>Перепроверка аккаунта возможна лишь в случае чистой истории банов у игрока, игрок более месяца играет у нас, без наличия других аккаунтов, если аккаунт имеет от 500 наиграных часов. Распространяется только на причину бана - выход при проверке, в других случаях перепроверка невозомжна.</li>
		<li>Если Вас забанили по результатам проверки с другого проекта. Разбан возможен лишь в случае полной перепроверки на изначальном проекте и последующем разбане там. Это распростраяется лишь на баны 2х летней давности и более.</li>
	</ul></blockquote>
</div></div>
