...
<p><li>Запрещено использовать/хранить/приобретать/распространять стороннее ПО или любые другие средства, позволяющие получить преимущество над другими игроками (Читы). Использование услуг читеров/макросников приравнивается к хранению.</li></p>\
...
<p><li>Запрещен флуд. Флудом считается отправка нескольких одинаковых сообщений, действий и/или команд в короткий промежуток времени.</li></p>\
...
<p><li>Запрещено оскорбление Администрации/Модерации в любых формах.</li></p>\
...
<p><li>Запрещена клевета, дезинформация, наговор, ложь на игроков/администрацию/модерацию и проект в целом.</li></p>\
...
<p><li>Вещи, купленные на проекте, не подлежат возврату, обмену или переносу, если они бесплатны, или уже были получены на сервере.</li></p>\
...
<p><li>Сервер может быть остановлен, перезагружен или удален в любое время.</li></p><br>\
...
<p>- Запрещено что либо чистить в компьютере, переустанавливать операционную систему и/или менять оборудование на протяжении всего вайпа, за который проходит ивент.</p>\
...
<p><li>Если вы не согласны с окончительным решением, принятым не в соответствии настоящих правил, вы можете затребовать у главного администратора материалы дела о вашей блокировке направив сообщение в наше официальное сообщество <a href="https://vk.com/grandrust_server" target="blank">GRAND RUST.</a> либо в сообщество <a href="https://vk.com/grmoder" target="blank">главного модератора.</a></li></p><br>\
</ul></div></div>'
};
...
<p>Хотите получать <b>5%</b>,<b>10%</b> или даже <b>15%</b> от ресурсов добытых другими игроками, прямо в ваш контейнер не выходя из дома?<br>\
...
<b>•</b> В первые 24 часа после вайпа вы будете получать от 5%.<br>\
...
<b>•</b> 2 часа - 6%, 4 часа - 7%, 6 часов - 8%, 8 часов - 9%, 10 часов - 10%.<br>\
...
<b>•</b> Вызов курьера обойдётся вам в 10% собраных ресурсов. (При вызове курьера во время рейда, рейдеры и вы получите по 50%, но ящик после этого будет считаться зарейженым).<br>\
<b>•</b> Если ваш ящик уничтожат, вы сможете взять новый только через 10 часов. Первый ящик абсолютно бесплатен для вас.<br><br>\
