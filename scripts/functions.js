...
<p>- Игрок заабузивший нашивку, теряет возможность принять повторное участие от 90 дней, а так же не получает нашивку.</p>\
<p>- Игрок, продавший или отдавший шкаф, теряет возможность принять повторное участие от 90 дней.</p>\
...
<a class="qiwi-inp-main qiwi-inp-other" id="qiwi-inp-other">\
	<div class="qiwi-widget-title">Другие способы</div><!--div class="qiwi-widget-title" style="font-size: 13px;color: red;">Внимание!<br>Этот метод пока работает не стабильно! Платёж идёт долго!<br>Нажмите через QIWI там есть вкладка через карту<br>QIWI работает нормально!</div>--><img class="qiwi-inp-other-img" src="https://pic.moscow.ovh/images/2020/12/24/08a847e9d7f387ec60b4b3c89a8879e9.png">\
</a></div>'
};
