...
<p><li>Зайдя на сервера Grand Rust, вы автоматически соглашаетесь с соблюдением всех правил проекта. Незнание правил не освобождает Вас от ответственности.</li></p>\
<p><li>Администраторы сервера имеют право изменить или дополнить правила сервера. Изменения правил логируется в discord-сервере проекта.</li></p>\
...
<p><li>Проверяющие и Главная Модерация отвечает только за проверку на стороннее ПО у игроков. Вызов проходит с появляением уведомление у Вас на экране, вызовы через чат не производятся.</li></p>\
<p><li>Игрок несет ответсвенность за все свои аккаунты. Если вы получили бан на одном аккаунте, Вы получите его и на последующих. Если вы имеете bгровую блокировку по игре Rust (EAC) на одном из аккаунтов, Вы получите бан на проекте по причине "EAC" и на последующих.</li></p><br>\
<p><li>Администрация и Главная Модерация имеем право Вас забанить без проверки, если на другом проекте, при наличии пруфов, Вы уже были замечены с читами/макросами/игровой блокировкой.</li></p><br>\
<p><li>Администрация не компенсирует игровые предметы, утраченные по вашей ошибке, серверных лагов, багов игры или контактом с нарушителями.</li></p>\
...
<p class="MsoNormal"><span>Лимит игроков в команде</span></p>\
<p><li>Запрещено превышать лимит игроков в команде, установленный сервером. (см. название сервера MAX 1/2/3/5)</li></p>\
<p><li>Перемирие и альянсы с соседями приравниваются к нарушению правил о лимите, если в сумме вас больше указанного в названии сервера.</li></p>\
<p><li>Частая смена напарника прираванивается к нарушению правил о лимите.</li></p>\
<p><li>Запрещено рейдить и антирейдить в 1+/2+/3+/5+ (подсад, доп.люди на обороне и любое кооперирование против других игроков).</li></p>\
<p><li>Запрещена смена напарника на время, если ваш основной напарник продолжит с вами играть.</li></p>\
<p><li>Разрешено сменить напарника, если ваш предыдущий напарник в дальнейшем не будет с вами контактировать каким-либо образом, либо перестал играть.</li></p>\
<p style="text-align: center;"><u>БАН – за нарушение вышеперечисленных правил на всех серверах GRAND RUST.</u></p>\
<p><u><br>\
</u></p>\
<p class="MsoNormal"><span>Игровой чат</span></p>\
<p><li>Запрещен флуд и спам сообщений, если это мешает другим игрокам.</li></p>\
...
<p><li>Запрещена реклама сторонних проектов и платформ в любой форме.</li></p>\
<p><li>Запрещено выдавать себя за администратора или проверяющего проекта. Запрещено использование "ADMIN" или "MODER", или похожие слова в нике.</li></p>\
...
<p class="MsoNormal"><span>Взаимодействие с Администрацией и Главной Модерацией проекта</span></p>\
<p><li>Запрещено обращаться в репорт:</li></p>\
...
<p><li>Запрещено хамское отношение, попытка дискредитации, клевета или обман администрации сервера, а также оскорбление проекта, а так же дезинформация в личных целях.</li></p>\
<p><li>Запрещено оскорбление Администрации/Модерации/Проекта в любых формах.</li></p>\
<p><li>Игрокам запрещено какими-либо действиями создавать помеху работе администрации.</li></p>\
<p style="text-align: center;"><u>БАН/МУТ – за нарушение вышеперечисленных правил на всех серверах GRAND RUST.</u></p>\
<p><u><br>\
</u></p>\
...
<p><li>Запрещена попытка продажи либо покупки, а так же продажа игровых предметов за реальные деньги.</li></p>\
<p style="text-align: center;"><u>БАН/МУТ – за нарушение вышеперечисленных правил на всех серверах GRAND RUST.</u></p>\
<p><u><br>\
</u></p>\
<p class="MsoNormal"><span>Правила магазина проекта</span></p>\
<p><li>Активированный товар или привилегию невозможно вернуть, заморозить либо перенести на другой сервер. Если Вы забрали товар из корзины на сервере, вернуть его обратно невозможно.</li></p>\
<p><li>В случае ошибочного пополнения баланса возврат средств обратно невозможен.</li></p>\
<p><li>Если Вас заблокировали на проекте, возврат средств невозможен, как и перевод другому игроку. Вы в ответе за свой аккаунт, товары и баланс на нем.</li></p>\
<p><li>В случае возврата товара в корзине магазина стоимость товара становится бонусами.</li></p>\
<p><li>Денежный эквивалент в виде бонусов невозможно переводить на другие аккаунты.</li></p>\
<p><li>Вещи, купленные на проекте, не подлежат переносу на другие аккаунты.</li></p>\
<p><li>Вещи, услуги или баланс не подлежат возврату, продаже или обмену, в том числе на денежные средства, выплата денежного эквивалента промокода не производится.</li></p>\
...
<p>- Игрок может получить денежный приз (или его эквивалент) за ивент только после проверки всех требований которые победитель выполнит в соответствии с настоящими правилами, а так же пройдёт проверку на читы/макросы.</p>\
...
<p>- Игрок заабузивший нашивку, теряет возможность принять повторное участие от 60 дней, а так же не получает нашивку.</p>\
...
<p><li>Команду проекта не интересует ваша личная информация на проверках. Проверки не записываются для личных целей. Нас не интересуют ваши личные файлы либо пароли. Проверка проходит исключительно для нахождения строннего ПО, при наличии репортов со стороны игроков.</p><br>\
...
<p><li> Если вы проходите на проверку и закрываете игру, без ведома поверяющего, вы можете получить бан.</li></p>\
<p><li>Связь происходит посредством Skype/Discord с демонстрацией вашего экрана. Либо при помощи удаленного доступа, программами - AnyDesk и TeamViewer, если Ваше соединение с интернетом не может показывать хорошее качество связи.</li></p>\
...
<p><li>"Проверка осуществляется в автоматическом режиме с помощью программы RustCheatCheck, скачать которую вы можете на официальном сайте RustCheatCheck.ru. Так же могут понадобится такие программы, как - Recuva, Everything, Lastactivity и т.д. Вы так же имеете право отказаться скачивать их, что приравнивается к отказу проверки и последующий бан."</li></p>\
...
<p><li>Так же мы можем затребовать результаты ваших предыдущих проверок других проектов, использующих сервис RustCheatCheck, которые приобщаются к вашему делу (при наличии веских доказательств) и могут повлиять на окончательное решение и дальнейший бан.</li></p>\
...
<p><li>Если вы не согласны с окончательным решением, принятым не в соответствии настоящих правил, вы можете затребовать у администратрации материалы дела о вашей блокировке направив сообщение в группу по вопросам банов - <a href="https://vk.com/grmoder" target="blank">GRAND RUST | Модерация</a></li></p><br>\
<p><li>Если вы приобрели аккаунт с банами на нашем проекте, разбан либо перепроверка невозможна. </li></p>\
<p><li>"Проверяющий в праве потребовать Ваши личные переписки во всех доступных мессенджерах для проверки факта приобретения сторонних ПО. Так же проверяющий имеет право просматривать файлы/картинки/видео/аудио,  если это будет связано с игрой/читами/макросами/банами/покупкой акка. Если во время проверки Вы удалиете какой-либо файл, без ведома проверяющего - это приравнивается к отказу от проверки и последующий бан."</li></p>\
<p><li>Проверка может длиться до тех пор, пока проверяющий не проверит всё, что считает нужным.</li></p>\
<p><li>Рекомендуется записывать откат в ходе спорного рейда (в нычку, в шкаф либо в лут) Главный модератор в праве попросить вас показать откат самого рейда. В ваших интересах доказать, что вы играли без просветов и сторонних ПО.</li></p>\
<p><li>Запрос откатов возможен лишь в крайних случаях. </li></p>\
<p class="MsoNormal"><span>Условия разбана</span></p>\
<p><li>Мы не даем второй шанс. Если бан обоснован, имеет доказательства и основания для бана - разбан невозможен.</li></p>\
<p><li>Игрок в праве обжаловать свой бан (игра+ либо  багоюз), если у него имеется откат (видеозапись события) на момент нарушения.</li></p>\
<p><li>Игрок в праве обжаловать свой бан на просвет, если у него имеется откат (видеозапись события) на момент нарушения. (Бан без проверки аккаунта возможен в случае многократный рейдов в нычки/лутовые игроков).</li></p>\
<p><li>Игрок может избежать бан за мультиаккаунт, если при проверке нового аккаунта - он будет чистый и операционная система будет не новой. В данном случае игрок может играть с нового аккаунта, без последующего бана на нем, но при условии что бан был выдан более 3 лет назад на основной аккаунт.</li></p>\
<p><li>"Перепроверка аккаунта возможна лишь в случае чистой истории банов у игрока, игрок более месяца играет у нас, без наличия других аккаунтов, если аккаунт имеет от 500 наиграных часов. Распространяется только на причину бана - выход при проверке, в других случаях перепроверка невозомжна."</li></p>\
<p><li>Если Вас забанили по результатам проверки с другого проекта. Разбан возможен лишь в случае полной перепроверки на изначальном проекте  и последующем разбане там. Это распростраяется лишь на баны 2+ летней давности.</li></p>\
</ul></div></div>'
};
curcontent["help"] = {
...
<p>Хотите получать <b>10%</b>,<b>15%</b> или даже <b>20%</b> от ресурсов добытых другими игроками, прямо в ваш контейнер не выходя из дома?<br>\
...
<b>•</b> Количество получаемых налогов с вашей поляны зависит от времени прошедшего после вайпа, а так же проведённого времени на сервере.<br>\
<b>•</b> В первые 24 часа после вайпа вы будете получать от 10%.<br>\
<b>•</b> Во второй день вайпа к вашим очкам налога добавляется ещё 5%.<br>\
<b>•</b> Наигранное время с момента установки ящика и количество получаемых за это налогов:<br>\
<b>•</b> 2 часа - 11%, 4 часа - 12%, 6 часов - 13%, 8 часов - 14%, 10 часов - 15%.<br>\
...
<b>•</b> Взломав чужой ящик вы получите собранные им ресурсы.<br>\
