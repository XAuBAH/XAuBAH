...
<p><li>Игрокам запрещено строить игровые постройки и предметы багом/недоработкой например в целях сделать несколько предметов друг в друге, слишком близко или с невозможностью уничтожения в целях получения преимущества над другими игроками.</li></p>\
...
<p><li>Запрещено нарушать правила ивентов прописанных в резделе "Правила участия в ивентах" ниже, в /help на серверах либо в отдельных командах плагинов, например /tc</li></p>\
...
<p><li>Вы можете быть забанены автоматической системой обнаружения подозрительных действий игрока, если вы не совершаои противоправных действий, пожалуйста напишите нам в группу ВК если вы были забанены по ошибке.</li></p>\
...
<br>\
<h4 class="serverheader">GRAND RUST#6 Custom/Hapis Max 2 </h4><p class="ipconnect">connect 6.grand-rust.ru:10000<a href="steam://connect/185.97.254.11:10000" title="Подключиться к серверу"><i class="fa fa-play"></i></a></p>\
<ul><li>Рейты x2, Стаки</li>\
<li>Рейты печек х3</li>\
<li>Система друзей - разрешено играть в 1+1 [Friends,FF,HitMarker]</li>\
'+ aboutserversdub +'\
