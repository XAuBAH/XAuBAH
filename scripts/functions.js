...
<p>- Победители, выполнившие настоящие правила, будут опубликованы в нашей группе Вк (в посте о глобал вайпе), только опубликованные в посте игроки получат нашивки в течении часа после публикации.</p><br>\
<p><li>Дуэли</li></p>\
...
После того как взлом был произведён, постарайтесь залутать ключ. В момент когда вы заберёте ключ из одного яшика, все остальные снова блокируются. За это время у вас будет шанс спрятать электронный ключ в безопасности. \
...
<br>\
<h4 class="serverheader">GRAND RUST#6 Procedural Max 2 </h4><p class="ipconnect">connect 6.grand-rust.ru:10000<a href="steam://connect/185.97.254.11:10000" title="Подключиться к серверу"><i class="fa fa-play"></i></a></p>\
<ul><li>Рейты x2, Стаки</li>\
<li>Рейты печек х3</li>\
<li>Система друзей - разрешено играть в 1+1 [Friends,FF,HitMarker]</li>\
'+ aboutserversdub +'\
