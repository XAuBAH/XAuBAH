...
<tbody>
  ...
  <tr>
    <td class="tg-2lax"- Игрок может получить денежный приз (или его эквивалент) за ивент только после проверки всех требований которые победитель выполнит в соответствии с настоящими правилами, а так же пройдёт проверку на читы/макросы.</td>
  </tr>
  <tr>
    <td class="tg-2lax">- Запрещено что-либо чистить в компьютере, переустанавливать операционную систему и/или менять оборудование на протяжении всего вайпа, за который проходит ивент.</td>
  </tr>
  <tr>
...
<tbody>
  ...
  <tr>
    <td class="tg-2lax">- Игрок заабузивший нашивку, теряет возможность принять повторное участие от 60 дней, а так же не получает нашивку.</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-2lax">- Рейтинг победителей не смещается, в случае нарушений.</td>
  </tr>
</tbody>
</table>
	</blockquote>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-2lax">Перепроверка аккаунта возможна лишь в случае чистой истории банов у игрока, малого количества репортов, игрок более месяца играет у нас, без наличия других аккаунтов, если аккаунт имеет от 500 наигранных часов. Распространяется только на причину бана - выход при проверке, в других случаях перепроверка невозможна.</td>
  </tr>
  <tr>
    <td class="tg-1lax">10.6</td>
    <td class="tg-2lax">Если вас забанили по результатам проверки с другого проекта то дальнейшая игра на нашем проекте невозможна, пока не будет получен разбан на изначальном проекте(ах), при условии, что:</td>
  <tr>
    <td class="tg-2lax">- Пройдена перепроверка на вышеперечисленном(ых) проекте(ах).</td>
  </tr>
      <td class="tg-2lax">- Ваш аккаунт имеет бан до 2020 года.</td>
  </tr>
      <td class="tg-2lax">- Нет других аккаунтов с банами.</td>
  </tr>
      <td class="tg-2lax">- Аккаунт имеет от 500 наигранных часов.</td>
  </tr>
      <td class="tg-2lax">- Нет мультиаккаунтов.</td>
  </tr>
  <tr>
