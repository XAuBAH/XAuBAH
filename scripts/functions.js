...
<p>- Игрок может получить денежный приз (или его эквивалент) за ивент только после проверки всех требовавний которые победитель выполнит в соответствии с настоящими правилами.</p>\
...
<p>- Победители, выполнившие настоящие правила, будут опубликованы в нашей группе Вк (в посте о глобал вайпе), только опубликованые в посте игроки получат нашивки в течении часа после публикации.</p><br>\
<p><li>Дуэли</li></p>\
