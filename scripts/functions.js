...
Также вы можете учавствовать в наших супер ивентах которые проходят на протяжении всего вайпа и уже получать настоящие деньги на вашу банковскую карту или на баланс магазина!</blockquote>\
     </div></div>\
<div class="x-spoiler">\
<input class="spoil-button" type="checkbox" tabindex="-1">\
...
<i class="fa fa-info-circle"></i> Также если вы купили 2 одинаковые группы вы можете либо активировать сначала одну, а через неделю другую либо вы можете активировать сразу несколько копий одной группы. Время будет складываться</blockquote>\
     </div></div>\
<div class="x-spoiler">\
<input class="spoil-button" type="checkbox" tabindex="-1">\
...
Также промокод получают те кто первый зашёл на сервер сразу после вайпа (обычно 100-150 чел.) и поиграл на сервере 10-20 минут. Вы получите уведомление при переходе по которому Вам перечислят деньги на баланс привязанного аккаунта в магазине<br><br>\
...
<i class="fa fa-info-circle"></i> Также, если вас очень смутил, убивший вас, подозреваемый читер, нажмите на соответствующую кнопку report на экране смерти, все ваши заявки очень тщательно рассматриваются нашим патрулём и мы проводим принудительную проверку всех подозреваемых вами игроков</blockquote>\
     </div></div>\
<!--<div class="x-spoiler">\
<input class="spoil-button" type="checkbox" tabindex="-1">\
...
<p><li>Игрокам запрещено строить дома в текстурах, а также застраивать игровые локации, препятствующие к использованию РТ.</li></p>\
...
<p><li>Администрация и проверяющие имеют право забанить весь состав друзей/сокланов за игру с читером, за игру с макросами при повторном аккаунте макросника к этим же друзьям а также за игру с использованием услуг читеров.</li></p>\
...
<p><li>Вам никто и ничего не должен, а также ни чем не обязан.</li></p>\
...
<p>- Игрок заабузивший нашивку, теряет возможность принять повторное участие от 30 дней, а также не получает нашивку.</p>\
...
<p><li>Проверка осуществляется в автоматическом режиме с помощью программы RustCheatCheck, скачать которую вы можете на официальном сайте RustCheatCheck.ru, вы также имеете право отказаться скачивать её, но в таком случае нам придётся заблокировать вас.</li></p>\
<p><li>Проверка также может проходить через программы AnyDesk и TeamViewer, если ваше соединение с интернетом не может показывать хорошее качество связи.</li></p>\
<p><li>Информация, которая может быть получена при вашей проверке не распространяется, за исключением результатов проверки, которые могут быть затребованы администрацией других проектов, также использующих сервис RustCheatCheck для своих проверок.</li></p>\
<p><li>Также мы можем затребовать результаты ваших предыдущих проверок других проектов, также использующих сервис RustCheatCheck, которые приобщаются к вашему делу (при наличии веских доказательств) и могут повлиять на окончательное решение.</li></p>\
...
//window.onload = function () {
	...
	curcontent["block"].xcon += '</div>\
	<br><i class="fa fa-info-circle"></i> Внимание! Вся эта таблица также доступна на сервере по команде /block для более подробного ознакомления с оставшимся временем до разблокировки!</div>';
