...
<p><li>Игрокам запрещено строить игровые постройки и предметы багом/не доработкой например в целях сделать несколько предметов друг в друге и/или слишком близко для получения преимущества.</li></p>\
