...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-2lax">Проверяющие и Главная Модерация отвечает только за проверку на стороннее ПО у игроков. Вызов проходит с появлением уведомление у Вас на экране, вызовы через чат не производятся.</td>
  </tr>
  <tr>
    <td class="tg-1lax">1.5</td>
    <td class="tg-2lax">Игрок несет ответсвенность за все свои аккаунты. Если вы получили бан на одном аккаунте, Вы получите его и на последующих. Если вы имеете игровую блокировку по игре Rust (EAC) на одном из аккаунтов, Вы получите бан на проекте по причине "EAC" и на последующих.</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-1lax">1.8</td>
    <td class="tg-2lax">Вам никто и ничего не должен, а также ни чем не обязан.</td>
  </tr>
</tbody>
</table>
	</blockquote>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-2lax">Игрокам запрещено строить дома в текстурах, а также застраивать игровые локации, препятствующие к использованию РТ.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-2lax">При обнаружении бага или недоработки игры/сервера незамедлительно сообщите администрации об этом через сообщение в нашу группу Вк.</td>
  </tr>
</tbody>
</table>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-2lax">Частая смена напарника прираванивается к нарушению правил о лимите.</td>
  </tr>
  <tr>
...
<div class="x-spoiler">
<input class="spoil-button" type="checkbox" tabindex="-1">
    <div class="spoil-box"><span class="spoil-close fa"></span><span class="spoil-open fa"></span><span class="spoil-head">Взаимодействие с Администрацией и Главной Модерацией проекта</span><br>
	<blockquote class="spoil-Untext">
<table class="tg">
<tbody>
  <tr>
    ...
    <td class="tg-2lax">
		Запрещено обращаться в репорт:
		<p>- По вопросам, не связанным с игрой или проблемами на сервере (оффтопить).</p>
		<p>- Оскорблять и дискредитировать работу модерации и проекта в целом.</p>
		<p>- Спамить или капсить.</p>
	</td>
  </tr>
  <tr>
    <td class="tg-1lax">5.2</td>
    <td class="tg-2lax">Запрещено хамское отношение, попытка дискредитации, клевета или обман администрации сервера, а также оскорбление проекта, а также дезинформация в личных целях.</td>
  </tr>
  <tr>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-2lax">Администрация и проверяющие имеют право забанить весь состав друзей/сокланов за игру с читером, за игру с макросами при повторном аккаунте макросника к этим же друзьям а также за игру с использованием услуг читеров.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-2lax">Вы можете быть забанены автоматической системой обнаружения подозрительных действий игрока, если вы не совершали противоправных действий, пожалуйста, напишите нам в группу ВК если вы были забанены по ошибке.</td>
  </tr>
  <tr>
    <td class="tg-1lax">6.11</td>
    <td class="tg-2lax">Запрещена попытка продажи либо покупки, а также продажа игровых предметов за реальные деньги.</td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
    ...
    <td class="tg-2lax">Активированный товар или привилегию невозможно вернуть, заморозить либо перенести на другой сервер. Если Вы забрали товар из корзины на сервере, вернуть его невозможно.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-2lax">В случае возврата товара в корзине магазина стоимость товара возвращается бонусами.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-2lax">Любые товары, купленные на проекте, не подлежат переносу на другие аккаунты, не подлежат возврату, продаже или обмену, в том числе на денежные средства, выплата денежного эквивалента промокода не производится.</td>
  </tr>
</tbody>
</table>
	</blockquote>
...
<tbody>
  <tr>
    <td class="tg-1lax">8.1.1</td>
    <td class="tg-2lax">Запрещено накручивать очки нашивок на друзьях.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.1.2</td>
    <td class="tg-2lax">Запрещено набивать на одном и том же игроке очки свыше 3 раз.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.1.3</td>
    <td class="tg-2lax">Запрещено абузить нашивки, например нашивки за «Уникальный шкаф».</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.1.4</td>
    <td class="tg-2lax">Игрок может получить денежный приз за ивент "Нашивки" только один раз.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.1.5</td>
    <td class="tg-2lax">Игроки могут получить денежный приз за ивент на одном конкретном сервере только один раз за глобал вайп нашивок. (Актуальные победители всегда перечислены в нашей группе Вк в постах и в специальном <a href="https://vk.com/@grandrust_server" target="blank">разделе статей</a>)</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.1.6</td>
    <td class="tg-2lax">Если вы намереваетесь выиграть денежный приз за ивент, пожалуйста, внимательно ознакомьтесь с настоящими правилами, это очень важно.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.1.7</td>
    <td class="tg-2lax">Игрок может получить денежный приз (или его эквивалент) за ивент только после проверки всех требований которые победитель выполнит в соответствии с настоящими правилами, а также пройдёт проверку на читы/макросы.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.1.8</td>
    <td class="tg-2lax">Запрещено что либо чистить в компьютере, переустанавливать операционную систему или менять оборудование на протяжении всего месяца, за который проходит ивент.</td>
  </tr>
</tbody>
</table>
		Уникальный шкаф
...
<tbody>
  <tr>
    <td class="tg-1lax">8.2.1</td>
    <td class="tg-2lax">Запрещено покупать, отдавать и т д. шкаф. Очки за шкаф зачтутся только в ходе честной игры.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.2.2</td>
    <td class="tg-2lax">Запрещено покупать/продавать информацию по местонахождению уникального шкафа у сторонних игроков, владельца или друзей владельца.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.2.3</td>
    <td class="tg-2lax">Игрок заабузивший нашивку, теряет возможность принять повторное участие от 60 дней, а также не получает нашивку.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.2.4</td>
    <td class="tg-2lax">Игрок, продавший или отдавший шкаф, теряет возможность принять повторное участие от 60 дней.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.2.5</td>
    <td class="tg-2lax">Запрещено ставить шкаф в чужом доме для последующего уничтожения.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.2.6</td>
    <td class="tg-2lax">Запрещено уничтожать шкаф друга или заранее договорившись с игроком.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.2.7</td>
    <td class="tg-2lax">Запрещено повышать очки чужого шкафа.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.2.8</td>
    <td class="tg-2lax">Игрок, у которого уничтожили шкаф, теряет 50 очков. Игрок всё равно может выиграть, если наберёт баллов более 0</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.2.9</td>
    <td class="tg-2lax">Победители, выполнившие настоящие правила, будут опубликованы в нашей группе Вк (в посте о глобал вайпе), только опубликованные в посте игроки получат нашивки в течение часа после публикации.</td>
  </tr>
  <tr>
    <td class="tg-1lax">8.2.10</td>
    <td class="tg-2lax">Рейтинг победителей не смещается, в случае если игрок выбыл с таблицы рейтинга.</td>
  </tr>
</tbody>
</table>
	</blockquote>
...
<tbody>
  <tr>
    ...
    <td class="tg-2lax">Команду проекта не интересует ваша личная информация на проверках. Проверки не записываются для личных целей. Нас не интересуют ваши личные файлы либо пароли. Проверка проходит исключительно для нахождения строннего ПО, при наличии репортов со стороны игроков.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-2lax">Как только вас вызвали на проверку - вам даётся до 10 минут, чтобы связаться с проверяющим, действуя инструкциям на экране, в противном случае вы можете получить блокировку.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-2lax">Проверка осуществляется в автоматическом режиме с помощью программы RustCheatCheck, скачать которую вы можете на официальном сайте RustCheatCheck.ru. Также могут понадобится такие программы, как - Recuva, Everything, Lastactivity и т.д. Вы также имеете право отказаться скачивать их, что приравнивается к отказу проверки и последующий бан.</td>
  </tr>
  <tr>
    <td class="tg-1lax">9.9</td>
    <td class="tg-2lax">Информация, которая может быть получена при вашей проверке не распространяется, за исключением результатов проверки, которые могут быть затребованы администрацией других проектов, также использующих сервис RustCheatCheck для своих проверок.</td>
  </tr>
  <tr>
    <td class="tg-1lax">9.10</td>
    <td class="tg-2lax">Также мы можем затребовать результаты ваших предыдущих проверок других проектов, использующих сервис RustCheatCheck, которые приобщаются к вашему делу (при наличии веских доказательств) и могут повлиять на окончательное решение и дальнейший бан.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-2lax">Если вы не согласны с окончательным решением, принятым не в соответствии настоящих правил, вы можете затребовать у администратрации материалы дела о вашей блокировке направив сообщение в группу по вопросам банов - <a href="https://vk.com/grmoder" target="blank">GRAND RUST | Модерация</a></td>
  </tr>
  <tr>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-2lax">Игрок в праве обжаловать свой бан на просвет, если у него имеется откат (видеозапись события) на момент нарушения. (Бан без проверки аккаунта возможен в случае многократный рейдов в нычки/лутовые игроков).</td>
  </tr>
  <tr>
    <td class="tg-1lax">10.4</td>
    <td class="tg-2lax">Игрок может избежать бан за мультиаккаунт, если при проверке нового аккаунта - он будет чистый и не будет найдено следов скрывания старого аккаунта. В данном случае игрок может играть с нового аккаунта, без последующего бана на нем, но при условии что бан был выдан более 3 лет назад на основной аккаунт.</td>
  </tr>
  <tr>
    <td class="tg-1lax">10.5</td>
    <td class="tg-2lax">Перепроверка аккаунта возможна лишь в случае чистой истории банов у игрока, игрок более месяца играет у нас, без наличия других аккаунтов, если аккаунт имеет от 500 наиграных часов. Распространяется только на причину бана - выход при проверке, в других случаях перепроверка невозомжна.</td>
  </tr>
  <tr>
    <td class="tg-1lax">10.6</td>
    <td class="tg-2lax">Если Вас забанили по результатам проверки с другого проекта. Разбан возможен лишь в случае полной перепроверки на изначальном проекте и последующем разбане там. Это распростраяется лишь на баны 2х летней давности и более.</td>
  </tr>
</tbody>
</table>
	</blockquote>
...
<!--<i class="fa fa-info-circle"></i>--> Также если в этом списке нет ваших любимых команд, вы всё ещё можете забиндить их традиционно. (Кавычки обьязательны)<br>
<div class="commandblock">
...
DOMReady(function () {
	...
	for (var i = 0; i < kit_prem.length; i+=4) {
		if(kit_prem[(i+1)] != null)
			...
			curcontent["kit-prem"].xcon += `<div class="kit-items__item"><div class="kit-item"><img class="kit-item__image" src="https://shop.grand-rust.ru/files/images/rust/items256/`+ kit_prem[i] +`.png"></div></div>`;
	
		if(kit_prem[(i+2)] != null)
			curcontent["kit-wars"].xcon += `<div class="kit-items__item"><div class="kit-item"><img class="kit-item__image" src="https://shop.grand-rust.ru/files/images/rust/items256/`+ kit_prem[i] +`.png">
										<div class="kit-item__quantity">x`+ kit_prem[(i+2)] +`</div></div></div>`;
		else {
			if(i==88)kit_prem[i] = "smg.thompson";
			curcontent["kit-wars"].xcon += '<div class="kit-items__item"><div class="kit-item"><img class="kit-item__image" src="https://shop.grand-rust.ru/files/images/rust/items256/'+ kit_prem[i] +'.png"></div></div>';
		}
	
		if(kit_prem[(i+3)] != null){
			if(i==92)kit_prem[i] = "ammo.rifle";
			curcontent["kit-elite"].xcon += `<div class="kit-items__item"><div class="kit-item"><img class="kit-item__image" src="https://shop.grand-rust.ru/files/images/rust/items256/`+ kit_prem[i] +`.png">
