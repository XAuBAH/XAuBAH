                ...
                return i(t, e), l(t, [{
                    ...
                    value: function() {
                        ...
                        return u.default.createElement(f.Modal, {
                            ...
                            toggle: i,
                            onExit: s,
                            modalClassName: "modal-kit"
                        }, u.default.createElement(f.ModalHeader, null, l[a]), u.default.createElement(f.ModalBody, null, u.default.createElement(E.default, {
                            product: t,
                            products: n,
                            lang: a
                        }), !!c && u.default.createElement("div", {
                            className: "kit__description",
                            dangerouslySetInnerHTML: {
                                __html: c
                            }
                        }), r && r.length > 1 && u.default.createElement(O.default, {
                            product: t,
                            servers: r
                        })), u.default.createElement(f.ModalFooter, null, u.default.createElement(y.default, {
                            type: "button",
                            disabled: p,
                            onClick: i
                            ...
                            group: [{
                                ...
                                position: 1,
                                type: "btn",
                                value: u.default.createElement(y.default, {
                ...
                return function(e, a) {
                    var o = r({
                        ...
                        componentDidMount: function() {
                            if ("undefined" != typeof document && document.createElement) {
                                ...
                                if (a && "function" == typeof a.handleClickOutside) {
                                    if ("function" != typeof(e = a.handleClickOutside(r))) throw Error("Component lacks a function for processing outside click events specified by the handleClickOutside config option.")
                                    ...
                                    if ("function" != typeof r.props.handleClickOutside) throw Error("Component lacks a handleClickOutside(event) function for processing outside click events.");
                                ...
                                var o = n.findDOMNode(r),
                                    ...
                                    u = s.length;
                                s.push(this), l[u] = i, this.props.disableOnClickOutside || this.enableOnClickOutside()
                            }
                        },
                        ...
                        componentWillUnmount: function() {
                            ...
                            e > -1 && (l[e] && l.splice(e, 1), s.splice(e, 1))
                        },
            ...
            var s = [],
                ...
                m = function(e, t, n, r, a, o, i) {
                    return function(t) {
                        ...
                        var s = t.target;
                        a && f(t) || p(s, e, r) !== document || n(t)
                    }
                };
            ! function(o, i) {
                r = [n(1), n(61), n(47)], void 0 !== (a = function(e, t, n) {
                    return n || (n = e.createClass), i(o, e, t, n)
        ...
        var c = Object.assign || function(e) {
            ...
            b = function(e) {
                function t() {
                    ...
                    return n = r = s(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(l))), r.state = {
                        showTooltip: !1
                ...
                return l(t, e), u(t, [{
                    ...
                    value: function() {
                        var e = this.props,
                            ...
                            l = void 0 === s ? [] : s,
                            u = e.id,
                            f = o(e, ["element", "loading", "children", "tooltip", "id"]);
                        return "boolean" == typeof r && (n = y.default, f = c({}, f, {
                            loading: r
                        })), "string" == typeof i && (i = h.I18n.t(i)), l && u && (l = [p.default.createElement(m.Tooltip, {
                            key: "1",
                            target: u,
                        ...
                        }, h.I18n.t(l))]), d.createElement.apply(void 0, [n, c({}, f, {
                            id: u
                        }), i].concat(a(l)))
                    }
                }]), t
    ...
    1064: function(e, t, n) {
        ...
        e.exports = Object.assign || function(e, t) {
            for (var n, o, i = r(e), s = 1; s < arguments.length; s++) {
                n = arguments[s], o = a(Object(n));
                for (var l = 0; l < o.length; l++) i[o[l]] = n[o[l]]
            }
            return i
        }
    },
    ...
    1067: function(e, t, n) {
        ...
        var o = Object.assign || function(e) {
            ...
            f = function(e) {
                ...
                return y ? "string" == typeof y ? y = p.I18n.t(y) : "object" === (void 0 === y ? "undefined" : i(y)) && (y = p.I18n.t(y.value, y.data)) : w && (y = p.I18n.t(w + "field." + (v || g) + ".label")), O ? "string" == typeof O && (O = p.I18n.t(O)) : w && (O = p.I18n.t(w + "field." + (v || g) + ".placeholder")), "number" == typeof n && (n = new Date(1e3 * n)), l.default.createElement("div", {
        ...
        var r = n(1064),
            ...
            u = o({
                ...
                getStateFromProps: function(e) {
                    var t, n, r, a, o = this.getFormats(e),
                        i = e.value || e.defaultValue;
                    return i && "string" == typeof i ? t = this.localMoment(i, o.datetime) : i && (t = this.localMoment(i)), t && !t.isValid() && (t = null), n = t ? t.clone().startOf("month") : this.localMoment().startOf("month"), r = this.getUpdateOn(o), a = t ? t.format(o.datetime) : i.isValid && !i.isValid() ? "" : i || "", {
                        updateOn: r,
                ...
                getFormats: function(e) {
                    ...
                    return !0 === t.date ? t.date = n.longDateFormat("L") : "days" !== this.getUpdateOn(t) && (t.time = ""), !0 === t.time && (t.time = n.longDateFormat("LT")), t.datetime = t.date && t.time ? t.date + " " + t.time : t.date || t.time, t
                },
                componentWillReceiveProps: function(e) {
                    ...
                    if (e.value === this.props.value && t.datetime === this.getFormats(this.props).datetime || (n = this.getStateFromProps(e)), void 0 === n.open && (this.props.closeOnSelect && "time" !== this.state.currentView ? n.open = !1 : n.open = this.state.open), e.viewMode !== this.props.viewMode && (n.currentView = e.viewMode), e.locale !== this.props.locale) {
                        ...
                        if (this.state.selectedDate) {
                            ...
                            n.selectedDate = a, n.inputValue = a.format(t.datetime)
                        }
                    }
                    if (e.utc !== this.props.utc && (e.utc ? (this.state.viewDate && (n.viewDate = this.state.viewDate.clone().utc()), this.state.selectedDate && (n.selectedDate = this.state.selectedDate.clone().utc(), n.inputValue = n.selectedDate.format(t.datetime))) : (this.state.viewDate && (n.viewDate = this.state.viewDate.clone().local()), this.state.selectedDate && (n.selectedDate = this.state.selectedDate.clone().local(), n.inputValue = n.selectedDate.format(t.datetime)))), this.props.isValidDate)
                        for (n.viewDate = n.viewDate || this.state.viewDate; !this.props.isValidDate(n.viewDate);) n.viewDate = n.viewDate.add(1, "day");
                    this.setState(n)
                },
                ...
                showView: function(e) {
                    var t = this;
                    return function() {
                        t.state.currentView !== e && t.props.onViewModeChange(e), t.setState({
                            currentView: e
                        })
                    }
                },
                ...
                updateTime: function(e, t, n, r) {
                    ...
                    return function() {
                        ...
                        o[i] = a.state[i].clone()[e](t, n), a.setState(o)
                    }
                },
                allowedSetTime: ["hours", "minutes", "seconds", "milliseconds"],
                setTime: function(e, t) {
                    var n, r = this.allowedSetTime.indexOf(e) + 1,
                        a = this.state,
                        o = (a.selectedDate || a.viewDate).clone();
                    for (o[e](t); r < this.allowedSetTime.length; r++) n = this.allowedSetTime[r], o[n](o[n]());
                ...
                updateSelectedDate: function(e, t) {
                    var n, r = e.target,
                        ...
                        i = this.state.selectedDate || o;
                    if (-1 !== r.className.indexOf("rdtDay") ? (-1 !== r.className.indexOf("rdtNew") ? a = 1 : -1 !== r.className.indexOf("rdtOld") && (a = -1), n = o.clone().month(o.month() + a).date(parseInt(r.getAttribute("data-value"), 10))) : -1 !== r.className.indexOf("rdtMonth") ? n = o.clone().month(parseInt(r.getAttribute("data-value"), 10)).date(i.date()) : -1 !== r.className.indexOf("rdtYear") && (n = o.clone().month(i.month()).date(i.date()).year(parseInt(r.getAttribute("data-value"), 10))), n.hours(i.hours()).minutes(i.minutes()).seconds(i.seconds()).milliseconds(i.milliseconds()), this.props.value) this.props.closeOnSelect && t && this.closeCalendar();
                    else {
                ...
                localMoment: function(e, t, n) {
                    ...
                    return n.locale && a.locale(n.locale), a
                },
                componentProps: {
                ...
                render: function() {
                    ...
                    }, this.props.inputProps))] : e += " rdtStatic", this.state.open && (e += " rdtOpen"), s.createElement("div", {
                        className: e
            ...
            s = i(a({
                render: function() {
                    ...
                    return e = [r.createElement("thead", {
                        ...
                        key: "tb"
                    }, this.renderDays())], t && e.push(t), r.createElement("div", {
                        className: "rdtDays"
                ...
                renderDays: function() {
                    var e, t, n, a, i = this.props.viewDate,
                        s = this.props.selectedDate && this.props.selectedDate.clone(),
                        l = i.clone().subtract(1, "months"),
                        c = i.year(),
                        u = i.month(),
                        d = [],
                        p = [],
                    ...
                    for (var h = l.clone().add(42, "d"); l.isBefore(h);) e = "rdtDay", a = l.clone(), l.year() === c && l.month() < u || l.year() < c ? e += " rdtOld" : (l.year() === c && l.month() > u || l.year() > c) && (e += " rdtNew"), s && l.isSame(s, "day") && (e += " rdtActive"), l.isSame(o(), "day") && (e += " rdtToday"), t = !m(a, s), t && (e += " rdtDisabled"), n = {
                        key: l.format("M_D"),
                        "data-value": l.date(),
                        className: e
                    }, t || (n.onClick = this.updateSelectedDate), p.push(f(n, a, s)), 7 === p.length && (d.push(r.createElement("tr", {
                        key: l.format("M_D")
                    }, p)), p = []), l.add(1, "d");
                    return d
                },
        ...
        var a = n(1),
            ...
            s = i(o({
                ...
                renderMonths: function() {
                    for (var e, t, n, r, o, i, s, l = this.props.selectedDate, c = this.props.viewDate.month(), u = this.props.viewDate.year(), d = [], p = 0, f = [], m = this.props.renderMonth || this.renderMonth, h = this.props.isValidDate || this.alwaysValidDate; p < 12;) e = "rdtMonth", n = this.props.viewDate.clone().set({
                        year: u,
                        month: p,
                        date: 1
                    }), o = n.endOf("month").format("D"), i = Array.from({
                        length: o
                    }, function(e, t) {
                        return t + 1
                    }), s = i.find(function(e) {
                        ...
                        return h(t)
                    }), r = void 0 === s, r && (e += " rdtDisabled"), l && p === l.month() && u === l.year() && (e += " rdtActive"), t = {
                        key: p,
                        "data-value": p,
                        className: e
                    }, r || (t.onClick = "months" === this.props.updateOn ? this.updateSelectedMonth : this.props.setDate("month")), f.push(m(t, p, u, l && l.clone())), 4 === f.length && (d.push(a.createElement("tr", {
                        key: c + "_" + d.length
                    }, f)), f = []), p++;
                    return d
                },
            ...
            i = o(a({
                ...
                renderYears: function(e) {
                    var t, n, a, o, i, s, l, c = [],
                        ...
                        m = this.props.isValidDate || this.alwaysValidDate;
                    for (e--; u < 11;) t = "rdtYear", a = this.props.viewDate.clone().set({
                        year: e,
                        month: 0,
                        date: 1
                    }), i = a.endOf("year").format("DDD"), s = Array.from({
                        length: i
                    }, function(e, t) {
                        return t + 1
                    }), l = s.find(function(e) {
                        ...
                        return m(t)
                    }), o = void 0 === l, o && (t += " rdtDisabled"), f && f.year() === e && (t += " rdtActive"), n = {
                        key: e,
                        "data-value": e,
                        className: t
                    }, o || (n.onClick = "years" === this.props.updateOn ? this.updateSelectedYear : this.props.setDate("year")), c.push(p(n, e, f && f.clone())), 4 === c.length && (d.push(r.createElement("tr", {
                        key: u
                    }, c)), c = []), e++, u++;
                    return d
                },
            ...
            s = i(a({
                ...
                calculateState: function(e) {
                    var t = e.selectedDate || e.viewDate,
                        n = e.timeFormat,
                        r = []; - 1 !== n.toLowerCase().indexOf("h") && (r.push("hours"), -1 !== n.indexOf("m") && (r.push("minutes"), -1 !== n.indexOf("s") && r.push("seconds")));
                    var a = !1;
                ...
                renderCounter: function(e) {
                    if ("daypart" !== e) {
                        var t = this.state[e];
                        return "hours" === e && -1 !== this.props.timeFormat.toLowerCase().indexOf(" a") && 0 == (t = (t - 1) % 12 + 1) && (t = 12), r.createElement("div", {
                            key: e,
                ...
                render: function() {
                    ...
                    }), !1 !== this.state.daypart && t.push(e.renderDayPart()), 3 === this.state.counters.length && -1 !== this.props.timeFormat.indexOf("S") && (t.push(r.createElement("div", {
                        className: "rdtCounterSeparator",
                        key: "sep5"
                ...
                updateMilli: function(e) {
                    ...
                    t === e.target.value && t >= 0 && t < 1e3 && (this.props.setTime("milliseconds", t), this.setState({
                        milliseconds: t
                    }))
                },
            ...
            p = function(e) {
                ...
                return e.map(function(e, n) {
                    var r = e.position,
                        ...
                        i = void 0 === o ? "addon" : o,
                        l = e.value;
                    if (a === t && l) return s.default.createElement("div", {
                        key: n,
            ...
            f = function(e) {
                ...
                return F && (!0 === F && (F = [{
                    ...
                    var n = e.children,
                        r = a(e, ["children"]),
                        i = e.value;
                    return n || (n = i), s.default.createElement(d.default, o({
                        key: t,
                        locale: I + "o."
                    }, r), n)
                }), _ = null, x = F), k && (k = c.I18n.t(I + "l")), _ && (_ = c.I18n.t(I + "p")), s.default.createElement("div", S, k && s.default.createElement("label", {
                    htmlFor: O
                }, k), s.default.createElement("div", {
                    className: "input-group"
                }, N && p(N), (0, i.createElement)(M, o({
                    id: O,
                    className: m,
                    name: h,
                    placeholder: _,
    ...
    1075: function(e, t, n) {
        ...
        var o = n(1),
            ...
            c = function(e) {
                ...
                return n && (r = l.I18n.t("" + o + r, s)), i.default.createElement("option", c, r)
            };
        t.default = c
    },
    1076: function(e, t, n) {
        ...
        t.PasswordField = function(e) {
            ...
            return s(t, e), c(t, [{
                ...
                value: function() {
                    ...
                    return d.default.createElement(f.Field, l({
    ...
    1077: function(e, t, n) {
        ...
        var a = n(1),
            ...
            l = o.default.createElement("div", {
                className: "product__servers product__servers-all-servers"
                ...
                return i(t, e), s(t, [{
                    ...
                    value: function() {
                        ...
                        return c.default.createElement("div", {
                            className: "kit-items"
                        }, t.products.map(function(e, t) {
                            var a = e.id,
                                o = e.quantity,
                                i = (0, f.findByProp)(n, "id", a);
                            return i ? c.default.createElement(p.default, {
                                key: t,
                                product: i,
                                quantity: o,
                                lang: r
        ...
        var a = n(1),
            ...
            c = function(e) {
                ...
                return o.default.createElement("div", {
                    className: "kit-items__item"
                }, o.default.createElement("div", {
                    className: (0, l.default)({
                        "kit-item": !0,
                        "kit-item_blueprint": 5 === a
                    })
                }, o.default.createElement("img", {
                    className: "kit-item__image",
                    src: i,
                    onError: function(e) {
                        e.target.src = "//i.imgur.com/mj5N737.png"
                    }
                }), o.default.createElement("div", {
                    className: "kit-item__name"
                }, s[r]), o.default.createElement("div", {
                    className: "kit-item__quantity"
                }, "x" + n)))
            };
        t.default = c
    }
